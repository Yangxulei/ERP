...
public class NormalEmpViewDAOImpl implements NormalEmpViewDAO {
	
	@Autowired
	HibernateTemplate htemplate;

	@Override
	public List<Normalemployeeview> find(Normalemployeeview example) {
		...
		return (List<Normalemployeeview>) htemplate.find(hql,values);
	}
}
